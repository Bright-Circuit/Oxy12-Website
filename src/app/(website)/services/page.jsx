...
export default function page() {
  ...
  const whyStandOutRef = useRef(null);

  // Check if sections are in view
  const expertiseInView = useInView(expertiseRef);
  const servicesInView = useInView(servicesRef);
  const whyStandOutInView = useInView(whyStandOutRef);
      ...
      <Box ref={expertiseRef}>
        <Container maxWidth="xl">
          ...
          >
            ...
            >
              We blend technical mastery with aesthetic precision to curate
              digital experiences that define the modern landscape.
            </Typography>
          </Box>
        </Container>
      </Box>
          ...
          <Grid container spacing={{ xs: 3, md: 4 }} alignItems="stretch">
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                >
                  <ColorLensIcon sx={{ color: "#FA832B", fontSize: "36px" }} />
                </Box>
                ...
                >
                  ...
                  usability, aesthetics, and conversion.
                </Typography>
              </Box>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                >
                  ...
                  Manage sales, inventory, and customer relationships from a
                  single platform.
                </Typography>
              </Box>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                >
                  ...
                  operations. Integrate all business processes with a unified,
                  efficient system.
                </Typography>
              </Box>
            </Grid>
