    ...
    <>
      ...
      <Box
        sx={{
          ...
          background:
            "url(/images/hero-images/hero.png) center center/cover no-repeat",
          padding: {
            xs: "50px 10px",
            sm: "50px 20px",
            md: "40px 0",
        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            <Typography
              variant="h1"
              sx={{
                fontSize: { xs: "45px", sm: "62px", md: "82px", lg: "98px" },
                fontWeight: 700,
            ...
            >
              We build innovative digital solutions that elevate your business.
              From web and mobile apps to cutting-edge ERP systems, we deliver
              excellence.
            </Typography>
      ...
      >
        <Container maxWidth="xl">
          <Grid container spacing={{ xs: 7, md: 2 }} alignItems="center">
            {/* Left Content */}
            ...
            <Grid item xs={12} md={8}>
              <Grid container spacing={{ xs: 6, md: 3 }} alignItems="stretch">
                ...
                <Grid item xs={12} sm={6} md={4}>
                  <Box
                    sx={{
                      ...
                      transition: "all 0.3s ease",
                      animation: featuresInView
                        ? "scaleInUp 0.8s ease-out 0.1s both"
                        : "none",
                      "&:hover": {
                ...
                <Grid item xs={12} sm={6} md={4}>
                  <Box
                    sx={{
                      ...
                      animation: featuresInView
                        ? "scaleInUp 0.8s ease-out 0.2s both"
                        : "none",
                      "&:hover": {
                        transform: {
                          xs: "translateY(0)",
                ...
                <Grid item xs={12} sm={6} md={4}>
                  <Box
                    sx={{
                      ...
                      transition: "all 0.3s ease",
                      animation: featuresInView
                        ? "scaleInUp 0.8s ease-out 0.3s both"
                        : "none",
                      "&:hover": {
                        border: "1px solid rgba(255, 122, 61, 0.5)",
                        boxShadow: "0 8px 24px rgba(255, 122, 61, 0.15)",
          ...
          <Grid container spacing={{ xs: 4, md: 6 }} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                >
                  In today's digital-first world, success depends on how
                  effectively your business connects, communicates, and grows
                  online. We help turn your vision into powerful digital
                ...
                >
                  Our focus is on creating modern, scalable, and high-performing
                  digital experiences tailored to your unique business needs.
                  From concept to launch, we ensure every solution is built with
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                <Box>
                  ...
                  >
                    We leverage cutting-edge technologies to deliver solutions
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                <Box>
                  ...
                  >
                    Your data security and product quality are our top
                    priorities. We follow industry best practices.
                  </Typography>
                </Box>
              </Box>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                <Box>
                  ...
                  >
                    We focus on scalable solutions that grow with your business
        ...
        <Container maxWidth="xl">
          ...
          <Box
            sx={{
              ...
              animation: servicesInView ? "fadeInUp 0.8s ease-out" : "none",
            }}
          >
            {/* "Services" Label */}
            <Typography
